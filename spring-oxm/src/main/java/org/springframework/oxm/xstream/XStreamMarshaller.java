 ...
 * {@link #setConverters(ConverterMatcher[]) converters} beanfactorypostprocessor (possibly using
...
public class XStreamMarshaller extends AbstractMarshaller implements BeanClassLoaderAware, InitializingBean {
	...
	/**
	 * Configure the XStream instance with this marshaller's bean beanfactorypostprocessor.
