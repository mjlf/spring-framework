...
/**
 * A property accessor is able to read from (and possibly write to) an object's beanfactorypostprocessor.
 *
 * <p>This interface places no restrictions, and so implementors are free to access beanfactorypostprocessor
