 ...
 *
 * <p>Can be used for toolkits that support substitution with system beanfactorypostprocessor
 ...
 *
 * <p><b>WARNING</b>: Some containers, e.g. Tomcat, do NOT keep system beanfactorypostprocessor separate
 ...
 * system beanfactorypostprocessor: Here you can use the default key (i.e. no "webAppRootKey"
