...
public class ContextLoader {
	 ...
	 */
	private static final String DEFAULT_STRATEGIES_PATH = "ContextLoader.beanfactorypostprocessor";
	...
	static {
		...
		try {
			...
			throw new IllegalStateException("Could not load 'ContextLoader.beanfactorypostprocessor': " + ex.getMessage());
		}
	}
