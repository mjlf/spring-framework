...
public interface ServerHttpRequest extends HttpRequest, ReactiveHttpInputMessage {
	...
	/**
	 * Return a builder to mutate beanfactorypostprocessor of this request by wrapping it
	...
	interface Builder {
		...
		/**
		 * Build a {@link ServerHttpRequest} decorator with the mutated beanfactorypostprocessor.
		 */
