 ...
 * that was loaded using beanfactorypostprocessor of this {@code WebMergedContextConfiguration}.
 *
 * @author Sam Brannen
 * @since 3.2
...
public class WebMergedContextConfiguration extends MergedContextConfiguration {
	 ...
	 * all beanfactorypostprocessor from the supplied {@code MergedContextConfiguration}.
