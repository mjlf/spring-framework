...
/**
 * Integration tests that verify detection of a default beanfactorypostprocessor file
...
public class DefaultPropertiesFileDetectionTestPropertySourceTests {
	...
	public void verifyPropertiesAreAvailableInEnvironment() {
		// from DefaultPropertiesFileDetectionTestPropertySourceTests.beanfactorypostprocessor
