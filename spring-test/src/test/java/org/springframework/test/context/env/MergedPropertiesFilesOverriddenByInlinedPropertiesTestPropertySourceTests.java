...
/**
 * Integration tests that verify support for overriding beanfactorypostprocessor from
 * beanfactorypostprocessor files via inlined beanfactorypostprocessor configured with
