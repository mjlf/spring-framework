...
/**
 * Integration tests that verify detection of default beanfactorypostprocessor files
...
public class ExtendedDefaultPropertiesFileDetectionTestPropertySourceTests extends
	...
	public void verifyPropertiesAreAvailableInEnvironment() {
		...
		// from ExtendedDefaultPropertiesFileDetectionTestPropertySourceTests.beanfactorypostprocessor
