 ...
 * Using an object here, rather than just storing all beanfactorypostprocessor in
 * a map keyed by property name, allows for more flexibility, and the
 * ability to handle indexed beanfactorypostprocessor etc in an optimized way.
 *
