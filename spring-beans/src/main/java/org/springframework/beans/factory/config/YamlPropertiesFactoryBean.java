 ...
 * useful hierarchical beanfactorypostprocessor. It's more or less a superset of JSON, so it
 ...
 * </pre>
 *
 * is transformed into these beanfactorypostprocessor:
 *
 * <pre class="code">
 ...
 * </pre>
 *
 * becomes beanfactorypostprocessor like this:
 *
 * <pre class="code">
...
public class YamlPropertiesFactoryBean extends YamlProcessor implements FactoryBean<Properties>, InitializingBean {
	 ...
	 * beanfactorypostprocessor with the content of all resources.
