...
public class GroovyBeanDefinitionReader extends AbstractBeanDefinitionReader implements GroovyObject {
	 ...
	 * to set beanfactorypostprocessor on the current bean definition.
	 */
	 ...
	 * beanfactorypostprocessor from the {@code GroovyBeanDefinitionReader} itself
	 * </ul>
	 */
	...
	/**
	 * A RuntimeBeanReference that takes care of adding new beanfactorypostprocessor to runtime references.
	 */
