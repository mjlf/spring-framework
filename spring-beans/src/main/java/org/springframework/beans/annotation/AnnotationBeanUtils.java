...
public abstract class AnnotationBeanUtils {
	...
	/**
	 * Copy the beanfactorypostprocessor of the supplied {@link Annotation} to the supplied target bean.
	 * Any beanfactorypostprocessor defined in {@code excludedProperties} will not be copied.
	 * @param ann the annotation to copy from
	 * @param bean the bean instance to copy to
	 * @param excludedProperties the names of excluded beanfactorypostprocessor, if any
