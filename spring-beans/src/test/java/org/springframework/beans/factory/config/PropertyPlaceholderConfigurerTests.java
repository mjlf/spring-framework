...
public class PropertyPlaceholderConfigurerTests {
	...
	public void localPropertiesViaResource() {
		...
		Resource resource = new ClassPathResource("PropertyPlaceholderConfigurerTests.beanfactorypostprocessor", this.getClass());
	 ...
	 * settings regarding resolving beanfactorypostprocessor from the environment.
	 */
	@Test
