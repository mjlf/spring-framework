 ...
 * "freemarkerSettings" and/or "templateLoaderPath" beanfactorypostprocessor.
...
public class FreeMarkerConfigurer extends FreeMarkerConfigurationFactory
	 ...
	 * FreeMarkerConfigurationFactory's beanfactorypostprocessor (inherited by this class)
