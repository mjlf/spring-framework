 ...
 * Formats for each are identical to the beanfactorypostprocessor format recognized
...
public class JdbcBeanDefinitionReader {
	...
	public void loadBeanDefinitions(String sql) {
		...
		this.jdbcTemplate.query(sql, rs -> {
			...
			// Make a beanfactorypostprocessor entry by combining bean name and property.
