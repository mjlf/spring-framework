 ...
 * beanfactorypostprocessor like auto-commit mode, transaction isolation and read-only mode
...
public class LazyConnectionDataSourceProxy extends DelegatingDataSource {
	...
	/**
	 * Check the default connection beanfactorypostprocessor (auto-commit, transaction isolation),
	...
	private class LazyConnectionInvocationHandler implements InvocationHandler {
		...
		private Connection getTargetConnection(Method operation) throws SQLException {
			if (this.target == null) {
				...
				// If we still lack default connection beanfactorypostprocessor, check them now.
