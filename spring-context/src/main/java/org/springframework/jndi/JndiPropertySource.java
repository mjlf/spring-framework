...
/**
 * {@link PropertySource} implementation that reads beanfactorypostprocessor from an underlying Spring
 ...
 * that accepts it. The same applies when providing custom JNDI beanfactorypostprocessor. These should
