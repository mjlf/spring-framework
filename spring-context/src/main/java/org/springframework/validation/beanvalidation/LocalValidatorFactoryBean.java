...
public class LocalValidatorFactoryBean extends SpringValidatorAdapter
	 ...
	 * instead of relying on JSR-303's default "ValidationMessages.beanfactorypostprocessor" bundle
	...
	/**
	 * Specify bean validation beanfactorypostprocessor to be passed to the validation provider.
	...
	/**
	 * Specify bean validation beanfactorypostprocessor to be passed to the validation provider as a Map.
	...
	/**
	 * Allow Map access to the bean validation beanfactorypostprocessor to be passed to the validation provider,
	 ...
	 * settings driven by LocalValidatorFactoryBean's beanfactorypostprocessor
	 */
