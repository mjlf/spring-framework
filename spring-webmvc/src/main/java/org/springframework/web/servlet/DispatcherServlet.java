...
public class DispatcherServlet extends FrameworkServlet {
	 ...
	 */
	private static final String DEFAULT_STRATEGIES_PATH = "DispatcherServlet.beanfactorypostprocessor";
	...
	static {
		// Load default strategy implementations from beanfactorypostprocessor file.
	 ...
	 * <p>Using this constructor indicates that the following beanfactorypostprocessor / init-params
	 * will be ignored:
	 * <ul>
		...
		if (this.handlerMappings == null) {
			...
			if (logger.isTraceEnabled()) {
				logger.trace("No HandlerMappings declared for servlet '" + getServletName() +
						"': using default strategies from DispatcherServlet.beanfactorypostprocessor");
			}
		}
	}
	 ...
	 * default set of strategies from {@literal DispatcherServlet.beanfactorypostprocessor}.
	 ...
	 * <p>The default implementation uses the "DispatcherServlet.beanfactorypostprocessor" file (in the same
