 ...
 * and/or "freemarkerSettings" and/or "templateLoaderPath" beanfactorypostprocessor.
...
public class FreeMarkerConfigurer extends FreeMarkerConfigurationFactory
	 ...
	 * If this is not set, FreeMarkerConfigurationFactory's beanfactorypostprocessor (inherited by
