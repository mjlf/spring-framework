 ...
 * {@link HttpServletBean} rather than HttpServlet directly, bean beanfactorypostprocessor are
...
public abstract class FrameworkServlet extends HttpServletBean implements ApplicationContextAware {
	...
	/**
	 * This method will be invoked after any bean beanfactorypostprocessor have been set and
