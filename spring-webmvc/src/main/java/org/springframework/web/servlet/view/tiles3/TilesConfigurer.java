...
public class TilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
	 ...
	 * respecting the "definitions", "preparerFactoryClass" etc beanfactorypostprocessor on this configurer.
	 * <p><b>NOTE: Specifying a custom TilesInitializer effectively disables all other bean
	 * beanfactorypostprocessor on this configurer.</b> The entire initialization procedure is then left
