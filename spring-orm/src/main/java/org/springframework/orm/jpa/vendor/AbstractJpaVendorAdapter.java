...
/**
 * Abstract {@link JpaVendorAdapter} implementation that defines common beanfactorypostprocessor,
 * to be translated into vendor-specific JPA beanfactorypostprocessor by concrete subclasses.
 *
...
public abstract class AbstractJpaVendorAdapter implements JpaVendorAdapter {
	 ...
	 * Custom vendor beanfactorypostprocessor may still fine-tune the database dialect. However,
