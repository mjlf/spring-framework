...
public interface HibernateOperations {
	...
	/**
	 * Execute an HQL query, binding the beanfactorypostprocessor of the given bean to
	...
	/**
	 * Execute a named query, binding the beanfactorypostprocessor of the given bean to
