...
public class JmsMessageEndpointManager extends GenericMessageEndpointManager
	 ...
	 * ActivationSpec beanfactorypostprocessor as suggested by the JCA 1.5 specification
	 * (plus a couple of autodetected vendor-specific beanfactorypostprocessor).
