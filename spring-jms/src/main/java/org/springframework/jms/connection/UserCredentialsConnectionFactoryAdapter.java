...
public class UserCredentialsConnectionFactoryAdapter
	 ...
	 * that is, values of the "username" and "password" bean beanfactorypostprocessor.
	 ...
	 * username and password (i.e. values of the bean beanfactorypostprocessor) otherwise.
	 ...
	 * Determine whether there are currently thread-bound credentials,
	 * using them if available, falling back to the statically specified
	 * username and password (i.e. values of the bean beanfactorypostprocessor) else.
