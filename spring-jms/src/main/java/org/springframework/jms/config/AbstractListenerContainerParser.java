 ...
 * common beanfactorypostprocessor that are identical for all listener container variants.
 *
...
abstract class AbstractListenerContainerParser implements BeanDefinitionParser {
	...
	/**
	 * Parse the common beanfactorypostprocessor for all listeners as defined by the specified
