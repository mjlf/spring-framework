 ...
 * to introspect available beanfactorypostprocessor without having to access the underlying
...
public abstract class EnumerablePropertySource<T> extends PropertySource<T> {
	...
	/**
	 * Return the names of all beanfactorypostprocessor contained by the
