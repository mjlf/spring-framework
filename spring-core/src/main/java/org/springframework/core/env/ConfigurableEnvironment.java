 ...
 * property sources. Allows clients to set and validate required beanfactorypostprocessor, customize the
 ...
 * </pre>
 *
 * <h4>Example: removing the default system beanfactorypostprocessor property source</h4>
 * <pre class="code">
 * MutablePropertySources propertySources = environment.getPropertySources();
 ...
 *
 * 提供了对属性资源的管理， 可以增删改查，重要的是， 当一个Environment被用到一个ApplicationContext中时，
 * 在调用ApplicationContext的refresh()方法前， 需要确定所有的资源环境可用
 */
public interface ConfigurableEnvironment extends Environment, ConfigurablePropertyResolver {
	 ...
	 * be searched when resolving beanfactorypostprocessor against this {@code Environment} object.
	 ...
	 * sources such as the set of system beanfactorypostprocessor or the set of system environment
	 * variables.
	 ...
	 * beanfactorypostprocessor map as a default {@link PropertySource} to be searched. Therefore, it is
	 ...
	 * e.g. system environment and system beanfactorypostprocessor.
