 ...
 * {@link #DEFAULT_PROFILES_PROPERTY_NAME} beanfactorypostprocessor.
 *
...
public abstract class AbstractEnvironment implements ConfigurableEnvironment {
	 ...
	 * }
	 * </pre>
	 * In this arrangement, beanfactorypostprocessor will be resolved against sources A, B, C, D in that
