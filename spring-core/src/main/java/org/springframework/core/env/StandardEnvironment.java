 ...
 * <ul>
 * <li>{@linkplain AbstractEnvironment#getSystemProperties() system beanfactorypostprocessor}
 * <li>{@linkplain AbstractEnvironment#getSystemEnvironment() system environment variables}
 * </ul>
 *
 * That is, if the key "xyz" is present both in the JVM system beanfactorypostprocessor as well as in
 * the set of environment variables for the current process, the value of key "xyz" from
 * system beanfactorypostprocessor will return from a call to {@code environment.getProperty("xyz")}.
 * This ordering is chosen by default because system beanfactorypostprocessor are per-JVM, while
 * environment variables may be the same across many JVMs on a given system.  Giving
 * system beanfactorypostprocessor precedence allows for overriding of environment variables on a
 * per-JVM basis.
 *
...
public class StandardEnvironment extends AbstractEnvironment {
	...
	/** JVM system beanfactorypostprocessor property source name: {@value}. */
