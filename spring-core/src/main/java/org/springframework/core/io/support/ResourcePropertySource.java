 ...
 * {@code "classpath:/com/myco/foo.beanfactorypostprocessor"} or {@code "file:/path/to/file.xml"}.
 *
 * <p>Both traditional and XML-based beanfactorypostprocessor file formats are supported; however, in
