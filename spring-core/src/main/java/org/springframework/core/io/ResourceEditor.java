 ...
 * {@code Resource} beanfactorypostprocessor instead of using a {@code String} location property.
 *
 * <p>The path may contain {@code ${...}} placeholders, to be
 * resolved as {@link org.springframework.core.env.Environment} beanfactorypostprocessor:
