 ...
 * to specify a charset for a beanfactorypostprocessor file. This is a capability that standard
 ...
 * to escape unicode characters in your beanfactorypostprocessor files, do <i>not</i> specify
 * an encoding for a Reader/Writer (like ReloadableResourceBundleMessageSource's
 * "defaultEncoding" and "fileEncodings" beanfactorypostprocessor).
 *
