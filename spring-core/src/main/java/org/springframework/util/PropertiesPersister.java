 ...
 * (which allows to specify an encoding for a beanfactorypostprocessor file).
 *
...
public interface PropertiesPersister {
	...
	/**
	 * Load beanfactorypostprocessor from the given InputStream into the given
	 * Properties object.
	...
	/**
	 * Load beanfactorypostprocessor from the given Reader into the given
	 * Properties object.
	 * @param props the Properties object to load into
	...
	/**
	 * Load beanfactorypostprocessor from the given XML InputStream into the
