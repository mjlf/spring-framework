 ...
 * beanfactorypostprocessor file, within the current application. FreeMarker beanfactorypostprocessor can be
 * overridden via "freemarkerSettings". All of these beanfactorypostprocessor will be set by
...
public class FreeMarkerConfigurationFactory {
	...
	/**
	 * Set beanfactorypostprocessor that contain well-known FreeMarker keys which will be
	...
	public Configuration createConfiguration() throws IOException, TemplateException {
		...
		// Merge local beanfactorypostprocessor if specified.
